package patterns.creational.abstract_factory.sample;

import patterns.creational.abstract_factory.sample.factory.*;

public class Main {
    public static void main(String[] args) {
        if (args.length != 2) {
            System.out.println("Usage: java Main filename.html class.name.of.ConcreteFactory");
            System.out.println("Example 1: java Main list.html patterns.creational.abstract_factory.sample.listfactory.ListFactory");
            System.out.println("Example 2: java Main div.html patterns.creational.abstract_factory.sample.divfactory.DivFactory");
            System.exit(0);
        }
